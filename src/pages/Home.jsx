        ...
        <div className="bg-black text-white">
            ...
            <section className="relative h-[90vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="relative text-center text-white z-10 px-6">
                    ...
                    <p
                        className="max-w-2xl mx-auto text-lg text-slate-300 animate-fadeUp"
                    ...
                    <div
                        className="mt-8 flex justify-center gap-4 animate-fadeUp"
            ...
            <section className="container-max py-16 grid lg:grid-cols-2 gap-10 items-center">
                ...
                <div
                    className="relative opacity-0 animate-scaleIn"
            ...
            <section className="container-max py-12">
                <div className="flex items-end justify-between gap-4">
                    ...
                    <Link to="/events" className="text-sm link">
                        {t("home.seeAll")}
                    </Link>
                </div>
            ...
            <section className="container-max py-12">
                <div className="flex items-end justify-between gap-4">
                    ...
                    <Link to="/past-events" className="text-sm link">
                        {t("home.seeAll")}
                    </Link>
                </div>
